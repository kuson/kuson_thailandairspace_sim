...
**Commits (in order):** `d7b59aa` T1 handles · `9c027a2` T2 terrain · `1b4a813` T3 objects+clamp · `6e79397` T4 daynight · `bacb432` T5 city lights · `97c5a1f` T6 water · `03bd1b7` fix city-lights logdepth · `0345578` T7 wind · `c09b44a` T8 G-limits · `c4d02f7` debug handle · this docs commit (T9).
